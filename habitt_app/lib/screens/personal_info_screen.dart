...
class _PersonalInfoScreenState extends State<PersonalInfoScreen> {
  ...
  Future<void> _loadUserData() async {
    ...
    setState(() {
      _nameController.text = prefs.getString(AppConstants.userNameVal) ?? '';
      _usernameController.text =
          prefs.getString(AppConstants.userNameVal) ?? '';
      _age = prefs.getDouble(AppConstants.ageVal) ?? 25;
      _country = prefs.getString(AppConstants.countryVal) ?? 'United States';
    });
  }

  Future<void> _saveUserData() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    await prefs.setString(AppConstants.userNameVal, _nameController.text);
    await prefs.setString(AppConstants.userNameVal, _usernameController.text);
