...
class _ReportsScreenState extends State<ReportsScreen> {
  ...
  Future<void> _loadWeeklyData() async {
    ...
    String? selectedHabitsMapString =
        prefs.getString(AppConstants.selectedHobbiesMap);
    ...
    String? storedData = prefs.getString(AppConstants.weeklyData);
    if (storedData == null) {
      ...
      await prefs.setString(AppConstants.weeklyData, jsonEncode(mixedData));
